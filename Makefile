...
mistar2gphocs:	mistar2gphocs.o libgab/utils.o MistarParser.o libgab/gzstream/gzstream.o SingleAllele.o AlleleRecords.o mistarOperations.o GenomicRange.o
	${CXX} -o $@ $^ $(LDLIBS) $(LDFLAGS) 
...
bam2mistar:	bam2mistar.o libgab/utils.o  libgab//gzstream/gzstream.o    
	${CXX} -o $@ $^ $(LDLIBS) $(LDFLAGS) bamtools/build/src/utils/CMakeFiles/BamTools-utils.dir/*cpp.o  bamtools/lib/libbamtools.a

bam2mistarNoEpo:	bam2mistarNoEpo.o libgab/utils.o  libgab//gzstream/gzstream.o    
	${CXX} -o $@ $^ $(LDLIBS) $(LDFLAGS) bamtools/build/src/utils/CMakeFiles/BamTools-utils.dir/*cpp.o  bamtools/lib/libbamtools.a
...
mistar2vcf:	mistar2vcf.o   MistarParser.o libgab/utils.o  libgab//gzstream/libgzstream.a  SingleAllele.o AlleleRecords.o
	${CXX} -o $@ $^ $(LDLIBS) $(LDFLAGS)
...
vcf2mistarNoEpo:	vcf2mistarNoEpo.o libgab/utils.o   tabix/libtabix.a SimpleVCF.o CoreVCF.o VCFreader.o  BAMTableObj.o BAMTABLEreader.o FilterVCF.o SetVCFFilters.o libgab//gzstream/gzstream.o
	${CXX}  -o $@ $^ $(LDLIBS) $(LDFLAGS)
